...
class ImgText extends Component {
    ...
    render() {
        ...
        const { id, name, type, content, isCollect } = this.props && this.props.id ? this.props : JSON.parse(Storage.getLocal("ImgTextProps"))
        return (
            <div className="ImgTextWrap">
                <div className="taocan2">
                    ...
                    <div className="imgText">
                        ...
                        <div />
                        <div style={{ marginBottom: '59px' }} className="content" dangerouslySetInnerHTML={{ __html: Utils.escape2Html(content) }}>
                        </div>
                    </div>
                </div>
