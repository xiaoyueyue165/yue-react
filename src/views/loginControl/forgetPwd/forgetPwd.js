...
class ForgetPwd extends React.Component {
    ...
    sendVscode = () => {
        ...
        fetch.post(`/api/${API.sendVcode}`, { mobile: this.state.username }).then(res => {
    ...
    */
    ...
    submitFn = () => {
        ...
        else if (!Utils.checkType(username, 'phone')) {
        ...
        return (
            <div className="forgetPwd_wrap center">
                <div className="forgetPwd">
                    ...
                    <Input className="commonInp" placeholder="请输入手机号" onChange={this.onFormChange.bind(this, 'username')} />
                    <img className="commonIcon" src={phone} />
                    <Input className="commonInp" placeholder="请输入验证码" onChange={this.onFormChange.bind(this, 'code')} />
                    <img className="commonIcon" src={msg} />
                    <div className="sendVscode_loginState" onClick={this.sendVscode}>发送验证码</div>
                    <Input.Password className="commonInp" placeholder="请输入新密码" onChange={this.onFormChange.bind(this, 'password')} />
                    <img className="commonIcon" src={pwd} />
                    <Input.Password className="commonInp" placeholder="请确认新密码" onChange={this.onFormChange.bind(this, 'password2')} />
                    <img className="commonIcon" src={pwd} />
                    <Button className="Btn" type="primary" onClick={this.submitFn}>确认</Button>
                </div>
            </div>
